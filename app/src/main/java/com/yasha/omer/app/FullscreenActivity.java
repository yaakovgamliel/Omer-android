...
public class FullscreenActivity extends Activity {
    ...
    private TextView omerCountText;
    private TextView hebrewDayText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View contentView = findViewById(R.id.omer_count);
...
//        findViewById(R.id.dummy_button).setOnTouchListener(mDelayHideTouchListener);
    ...
    private void setupUIElements() {
        ...
        weekDayText   = (TextView)findViewById(R.id.week_day_text);
    ...
    private void updateTextLabels(){
        ...
        if (currentHour >= 19 && currentHour < 24) {
            ...
            String formatedString = String.format("%d w %d d",weeks,days);
